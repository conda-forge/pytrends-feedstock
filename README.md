...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytrends-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11296&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytrends-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytrends` can be installed with:

```
conda install pytrends
```

It is possible to list all of the versions of `pytrends` available on your platform with:
